...
class FlaskRestApiTest:
    ...
    def __init__(self, p_ini_pth, p_logger=False):
        ...
        self.logger = None
        if p_logger:
            self.logger_name = FlaskRestApiTest
    ...
    def test_func(self):
        '''Method description'''
        print(colored('Testing FlaskRestApiTest...', 'yellow'))
        return True
...
# end FlaskRestApiTest


def init_logger():
    logger = logging.getLogger(FlaskRestApiTest)
...
if __name__ == '__main__':
    ...
    t_flaskrestapitest = FlaskRestApiTest(ini_pth)
    if t_flaskrestapitest.success:
        t_flaskrestapitest.run()
    b_tls.print_footer()
# end __main__
